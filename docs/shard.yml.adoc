...
+
*Example:* _github: your-org/amber-support_
...
Here is an example _shard.yml_ for a library named _amberverse_toolkit_ at version _1.2.3_
with some dependencies:

[source,yaml]
----
name: amberverse_toolkit
version: 1.2.3
crystal: '>= 0.35.0'
...
description: |
  Agent-friendly support library for Amberverse projects
...
targets:
  amberverse_toolkit:
    main: src/amberverse_toolkit.cr
----
