...
shards mcp logs   # Tail server logs
```
...
shards run-script       # Run for a specific shard
```
...
Please refer to [https://crystal-lang.org/install/](https://crystal-lang.org/install/) for
